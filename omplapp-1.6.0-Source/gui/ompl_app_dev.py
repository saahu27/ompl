...
# Backward compatibility for PyQt6, PyQt5, and PySide2
try:
    ...
    try:
        ...
        from PySide2 import QtWidgets, QtCore, QtGui, QtOpenGL
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # Connect to OMPL's console output
...
class MainWidget(QtWidgets.QWidget):
    def __init__(self, robotTypes, parent=None, flags=QtCore.Qt.WindowType(0)):
