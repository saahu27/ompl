...
foreach(_dir /usr/include;/usr/include;;TRIANGLE_INCLUDE_DIR-NOTFOUND;/usr/include;/usr/include;/usr/include;PQP_INCLUDE_DIR-NOTFOUND;/usr/include;/usr/include;/usr/include)
    if(_dir)
...
foreach(_dir /usr/lib/x86_64-linux-gnu;/usr/lib;/usr/lib/x86_64-linux-gnu;;/usr/lib/x86_64-linux-gnu;)
    if(_dir)
...
if (OMPLAPPBASE_LIBRARY AND OMPLAPP_LIBRARY)
    set(OMPLAPP_LIBRARIES "${OMPLAPPBASE_LIBRARY};${OMPLAPP_LIBRARY};assimp::assimp;fcl")
    if(OPENGL_LIBRARIES)
